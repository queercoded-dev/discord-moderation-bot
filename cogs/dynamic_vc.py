...
class DynamicVC(commands.Cog):
    ...
    async def on_voice_state_update(self, member: discord.Member,
        ...
        if before.channel != after.channel and after.channel:  # if they join a voice channel
            if after.channel.id == DYN_VC_ID:  # if they join the DVC channel
        ...
        elif before.channel and before.channel.id in self.channels:  # if they left a chat we made
